...
/**
 * Abstract multi page form presenter
 *
 * @param <E> base entity
 * @param <V> view
 * @param <S> service
 ...
 * @author Cem Ikta
 */
public abstract class AbstractMultiPageFormPresenter<E extends BaseEntity, 
        V extends MultiPageFormView<E>, S extends AbstractService<E>>
            implements MultiPageFormPresenter<E, V, S> {
    ...
    public AbstractMultiPageFormPresenter(final NavigationManager navigationManager,
