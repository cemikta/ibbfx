...
/**
 * Adresse Bank view interface
 *
 * @author Cem Ikta
 */
public interface AdresseBankView extends TabView {

    TextField getTfKontoInhaber();
    ...
    DatePicker getDpLetzteSpendeAm();

    NumberField getNfBetrag();

    NumberField getNfSpendensumme();
