...
/**
 * App user view interface
 *
 * @author Cem Ikta
 */
public interface AppUserView extends BrowserFormView<AppUser> {
    ...
    ComboBox<AppUserRole> getCbAppUserRole();

    ComboBox<AppUserGroup> getCbAppUserGroup();

    CheckBox getChbActive();
