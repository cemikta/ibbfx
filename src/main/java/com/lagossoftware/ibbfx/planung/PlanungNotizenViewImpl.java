...
/**
 * Planung Notizen view implementation
 *
 * @author Cem Ikta
 */
public class PlanungNotizenViewImpl extends GridPane implements PlanungNotizenView {

    private TextArea tfNotizen;

    public PlanungNotizenViewImpl() {
        buildView();
    }
    ...
    private void buildView() {
        ...
        add(new TitledSeparator(I18n.PLANUNG.getString("planung.form.notizen")), 0, 0, 3, 1);
        add(tfNotizen, 0, 1, 2, 1);
    }

    @Override
    public String getTitle() {
        return I18n.PLANUNG.getString("planung.form.tabNotizen");
    }
