...
/**
 * Planung Zuschuss view interface
 *
 * @author Cem Ikta
 */
public interface PlanungZuschussView extends TabView {

    Button getBtnAddNewZuschuss();

    Button getBtnEditZuschuss();

    ListView<Zuschuss> getZuschussListView();
