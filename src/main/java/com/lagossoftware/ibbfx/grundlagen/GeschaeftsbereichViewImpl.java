...
/**
 * Geschaeftsbereich view implementation
 *
 * @author Cem Ikta
 */
public class GeschaeftsbereichViewImpl extends AbstractBrowserFormView<Geschaeftsbereich> 
        implements GeschaeftsbereichView {

    private TextField tfAbkuerzung;
    private TextField tfName;

    public GeschaeftsbereichViewImpl() {
        super();
        buildView();
    }
    ...
    public String getHeaderTitle() {
        return I18n.GRUNDLAGEN.getString("geschaeftsbereich.title");
    }
