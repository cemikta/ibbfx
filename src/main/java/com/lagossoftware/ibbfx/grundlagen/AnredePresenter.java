 ...
 * @author Cem Ikta
 */
public class AnredePresenter extends AbstractBrowserFormPresenter<Anrede, AnredeView, AnredeService> {
    
    @Inject
    public AnredePresenter(final NavigationManager navigationManager, 
            final Logger logger, final AnredeView view, final AnredeService service) {
    ...
    public String getNamedQuery() {
        return Anrede.FIND_ALL;
    }

    @Override
    public String getNamedQueryWithFilter() {
        return Anrede.FIND_BY_BEZEICHNUNG;
    }
