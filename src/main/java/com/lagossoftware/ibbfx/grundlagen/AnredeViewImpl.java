...
/**
 * Anrede view implementation
 *
 * @author Cem Ikta
 */
public class AnredeViewImpl extends AbstractBrowserFormView<Anrede> implements AnredeView {

    private TextField tfBezeichnung;

    public AnredeViewImpl() {
        super();
        buildView();
    }
    ...
    public String getHeaderTitle() {
        return I18n.GRUNDLAGEN.getString("anrede.title");
    }
