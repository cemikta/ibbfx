 ...
 * @author Cem Ikta
 */
public class StichwortPresenter extends AbstractBrowserFormPresenter<Stichwort, 
        StichwortView, StichwortService> {
    
    @Inject
    public StichwortPresenter(final NavigationManager navigationManager, 
            final Logger logger, final StichwortView view, final StichwortService service) {
    ...
    public String getNamedQuery() {
        return Stichwort.FIND_ALL;
    }

    @Override
    public String getNamedQueryWithFilter() {
        return Stichwort.FIND_BY_BEZEICHNUNG;
    }
