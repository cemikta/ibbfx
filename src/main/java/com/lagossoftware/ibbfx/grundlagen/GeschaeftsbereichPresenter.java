...
/**
 * Geschaeftsbereich presenter
 *
 * @author Cem Ikta
 */
public class GeschaeftsbereichPresenter extends AbstractBrowserFormPresenter<Geschaeftsbereich, 
        GeschaeftsbereichView, GeschaeftsbereichService> {
    
    @Inject
    public GeschaeftsbereichPresenter(final NavigationManager navigationManager, 
            final Logger logger, final GeschaeftsbereichView view, 
            final GeschaeftsbereichService service) {
    ...
    public String getNamedQuery() {
        return Geschaeftsbereich.FIND_ALL;
    }

    @Override
    public String getNamedQueryWithFilter() {
        return Geschaeftsbereich.FIND_BY_NAME;
    }
    ...
    public AppPlaces getPlaceName() {
        return AppPlaces.GESCHAEFTSBEREICH;
    }
