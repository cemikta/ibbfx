...
/**
 * FahrtkasseWaehrung service
 *
 * @author Cem Ikta
 */
public class FahrtkasseWaehrungService extends AbstractService<FahrtkasseWaehrung> {

    public FahrtkasseWaehrungService() {
        super(FahrtkasseWaehrung.class);
    }
